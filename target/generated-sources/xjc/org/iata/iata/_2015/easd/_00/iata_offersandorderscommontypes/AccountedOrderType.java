 ...
 *         &lt;element name="OrderKeys" type="{http://www.iata.org/IATA/2015/EASD/00/IATA_OffersAndOrdersCommonTypes}OrderStructureKeyType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class AccountedOrderType {
    ...
    protected List<OrderStructureKeyType> orderKeys;
     ...
     * 
     */
    public List<OrderStructureKeyType> getOrderKeys() {
        if (orderKeys == null) {
            orderKeys = new ArrayList<OrderStructureKeyType>();
        }
