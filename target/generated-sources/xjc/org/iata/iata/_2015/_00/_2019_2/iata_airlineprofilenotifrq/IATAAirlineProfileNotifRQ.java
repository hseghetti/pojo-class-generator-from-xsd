 ...
 *           &lt;/complexType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="MessageDoc" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirlineProfileNotifRQ}MessageDocType" minOccurs="0"/&gt;
 *         &lt;element name="Notif" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirlineProfileNotifRQ}NotifType"/&gt;
 *         &lt;element name="Party" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirlineProfileNotifRQ}PartyType" minOccurs="0"/&gt;
 *         &lt;element name="PayloadAttributes" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirlineProfileNotifRQ}IATA_PayloadStandardAttributesType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "IATA_AirlineProfileNotifRQ")
public class IATAAirlineProfileNotifRQ {

    @XmlElement(name = "AugmentationPoint")
    protected IATAAirlineProfileNotifRQ.AugmentationPoint augmentationPoint;
    @XmlElement(name = "MessageDoc")
    protected MessageDocType messageDoc;
    @XmlElement(name = "Notif", required = true)
    protected NotifType notif;
     ...
     * @return
     *     possible object is
     *     {@link IATAAirlineProfileNotifRQ.AugmentationPoint }
     *     
     */
    public IATAAirlineProfileNotifRQ.AugmentationPoint getAugmentationPoint() {
     ...
     *     
     */
    public void setAugmentationPoint(IATAAirlineProfileNotifRQ.AugmentationPoint value) {
     ...
     *     
     */
    public void setNotif(NotifType value) {
        this.notif = value;
    }
