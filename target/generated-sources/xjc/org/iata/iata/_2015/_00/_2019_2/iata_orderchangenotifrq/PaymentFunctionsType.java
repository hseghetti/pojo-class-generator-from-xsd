 ...
 *       &lt;sequence&gt;
 *         &lt;element name="PaymentProcessingSummary" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OrderChangeNotifRQ}PaymentProcessingSummaryType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="PaymentSupportedMethods" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OrderChangeNotifRQ}PaymentSupportedMethodsType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class PaymentFunctionsType {
    ...
    @XmlElement(name = "PaymentSupportedMethods")
    protected List<PaymentSupportedMethodsType> paymentSupportedMethods;
    ...
    /**
     * Gets the value of the paymentSupportedMethods property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the paymentSupportedMethods property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPaymentSupportedMethods().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PaymentSupportedMethodsType }
     * 
     * 
     */
    public List<PaymentSupportedMethodsType> getPaymentSupportedMethods() {
        if (paymentSupportedMethods == null) {
            paymentSupportedMethods = new ArrayList<PaymentSupportedMethodsType>();
        }
        return this.paymentSupportedMethods;
    }
