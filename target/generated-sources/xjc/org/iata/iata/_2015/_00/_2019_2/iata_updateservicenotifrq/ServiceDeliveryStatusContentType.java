...
/**
 * <p>Java class for ServiceDeliveryStatusContentType.
 * 
 ...
 * 
 */
@XmlType(name = "ServiceDeliveryStatusContentType")
@XmlEnum
public enum ServiceDeliveryStatusContentType {
    ...
    ServiceDeliveryStatusContentType(String v) {
        value = v;
    }
    ...
    public static ServiceDeliveryStatusContentType fromValue(String v) {
        for (ServiceDeliveryStatusContentType c: ServiceDeliveryStatusContentType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
